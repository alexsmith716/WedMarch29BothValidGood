// cd documents/node3/oct31tonov1/wedmarch29bothvalidgood
...
if (app.get('env') === 'development') {
  ...
  app.use(function (err, req, res, next) {
    ...
    console.log('####### > app.js > app.use > ERROR > IS IT AJAX ???', req.xhr);
    console.log('####### > app.js > app.use > ERROR > req.headers[referer]: ', req.headers['referer'])
    console.log('####### > app.js > app.use > ERROR > err.name: ', err.name)
    console.log('####### > app.js > app.use > ERROR > err.code: ', err.code)
    console.log('####### > app.js > app.use > ERROR > err.message: ', err.message)
    //console.log('####### > app.js > app.use > ERROR > err: ', err)

    if (err.code === 'EBADCSRFTOKEN') {
      console.log('####### > app.js > app.use >>>>> EBADCSRFTOKEN ERROR !!!!!!!')
    }
