...
var helper = {
    ...
    initializeJqueryEvents:  function(){
        ...
        $('#signUpForm').on('submit', function(e) {
            ...
            console.log('#signUpForm > SUBMIT > GOOD +++');
            ...
            console.log('UBGUUUBBUBBUHBHBHBGBJHBHJUBJH: ', constrainedFormElements.length)

/*
1) Client validation can be spoofed. Run normal client HTML5 validation on submit

2) Client validation is submitted to Server and validated

3) If Server validation succeeds, user is redirected

4) If Server validation fails, validatedUserInput JObj is sent to client handleErrorResponse and errors are displayed

5) If Server validation fails, errors are displayed, user edits errors and resubmits form

+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++


I. Form tests if HTML5 is working (constrainedFormElements) and if there are errors error handlers are fired
...
*/
            ...
            if(constrainedFormElements.length > 0){
                ...
                for( var i = 0; i < constrainedFormElements.length; i++ ) {
                    formElement = $(constrainedFormElements[i]);
                    checkConstraints = formElement.get(0).checkValidity();

                    console.log('#signUpForm > SUBMIT > SAFARI +++ 1111: ', formElement, ' || ', checkConstraints);
                    ...
                    if(!checkConstraints){
                        ...
                        //if(is_safari){
                            ...
                            if(focusFirstElement === null){
                                focusFirstElement = constrainedFormElements[i];
                                //focusFirstElement.focus();
                            }
                            var boundEventTypes = $._data( formElement[0], 'events' );
                    ...
                    if(is_safari){
                        var boundEventTypes = $._data( formElement[0], 'events' );
                        for (var eType in boundEventTypes){
                            console.log('#signUpForm > SUBMIT > SAFARI +++ boundEventTypes 1/2/3: ', formElement.attr('id'), ' || ', eType, ' || ', formElement.val());
                            helper.handleFormEvents(formElement.attr('id'), eType, formElement.val());
            ...
            console.log('#signUpForm > SUBMIT > SAFARI +++ 2222: ', formValid, ' || ', formElement, ' || ', checkConstraints);
            ...
            */
            ...
            console.log('#signUpForm > SUBMIT > SAFARI +++ 2222: ', formElement, ' || ', checkConstraints, ' || ', formValid);

            if (!formValid && formElement !== undefined){
                console.log('+++++++++++ BAD FORM!');
                focusFirstElement = null;
                hideLoading();
                return false;
    ...
    handleFormEvents: function(elementID, eType, elementVal) {
        console.log('#handleFormEvents > 1/2/3: ', elementID, ' || ', eType, ' || ', elementVal);
