...
/* ============================================================ */
        ...
        $('#confirmPassword').on('change input', function(e) {
            helper.handleFormEvents($(this).attr('id'), e.type);
        });
    ...
    selectElementValidation: function(elementID, err1) {
        ...
        console.log('#selectElementValidation 1/2/3:', elementID, ' :: ', err1, ' :: ', thisElementValue);
    ...
    testUserInput: function(elementID, pattern, err1) {
        ...
        if(thisElementValue === ''){
            ...
            console.log('#testUserInput 3++++++++++++++++++111:', elementID, ' :: ', err1);
    ...
    testUserInputEmail: function(elementID, err1) {
        ...
        if ((err1 !== undefined && (err1.error === 'false' || err1.error === 'match')) || (err1 === undefined && isEmailValid)) {
            ...
            console.log('#testUserInputEmail 1 > elementID/err1', elementID, ' :: ', err1)
            ...
            console.log('#testUserInputEmail 2 > elementID/err1', elementID, ' :: ', err1)
            ...
            console.log('#testUserInputEmail 3 > elementID/err1', elementID, ' :: ', err1)
    ...
    validateEmailField: function(elementVal, thisField, comparedField, err1) {
        ...
        if ((err1 !== undefined && (err1.error !== 'invalid' && err1.error !== 'empty')) || isEmailValid) {
            ...
            if(isEmailValid){
                ...
                console.log('#validateEmailField 22222 > thisField/err1', thisField, ' :: ', err1)
                helper.validateEmailService(elementVal, function(notRegistered) {

                    if(!notRegistered){
                        console.log('#validateEmailField 33333 > 1/2/3/4: ', elementVal, ' :: ', thisField, ' :: ', err1, ' :: ', notRegistered)
                        ...
                        console.log('#validateEmailField 44444 > 1/2/3/4: ', elementVal, ' :: ', thisField, ' :: ', err1, ' :: ', notRegistered)
                ...
                if(err1 !== undefined && err1.error === 'registered'){
                    console.log('#validateEmailField 55555 > thisField/err1', thisField, ' :: ', err1)
                    ...
                    console.log('#validateEmailField 666666 > thisField/err1', thisField, ' :: ', err1)
        ...
        if((err1 !== undefined && err1.error === 'invalid') || (err1 === undefined && !isEmailValid)){
            ...
            console.log('#validateEmailField 7777 > thisField/err1', thisField, ' :: ', err1)
            ...
            if(err1 !== undefined || is_safari){
                ...
                console.log('#validateEmailField 8888 > thisField/err1', thisField, ' :: ', err1)
                $('#'+thisField+'Improper').removeClass('hide').addClass('show');

            }else{

                console.log('#validateEmailField 9999 > thisField/err1', thisField, ' :: ', err1)
    ...
    handleErrorResponse: function(data) {
        ...
        console.log('handleErrorResponse > data +++++: ', data);
